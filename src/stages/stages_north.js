...
S.rooftop_north = new Stage("北棟屋上", 4320, {
  ...
  new Event_Conversation(new vec(2160, 580), 40, new Iimage("images/ch_citri.png", 0, 0, 380, 380), [
    "シトリ:<br>うわ、びっくりした<br>よく来たねこんなとこまで",
    "アモン:<br>何してるんだ?",
    "シトリ:<br>か、風を感じてただけだよぉ<br>疑わないでね",
    "プリン:<br>質問!あなたはなぜ働いているの?",
    "シトリ:<br>......働いている理由なんてない。<br>けど、働いていないとあたしは何物でもない",
    "シトリ:<br>辞めたいよね、お仕事",
    "アモン:<br>じゃあ今日くらいは遊んでもいいんじゃないのか?<br>一緒に行こうぜ!",
    "シトリ:<br>......じゃあ遊んじゃおっかな!<br>そうだ、知ってる?旧校舎のこと<br>行ってみたかったんだよねー!",
    "シトリが仲間になった",
  ],
