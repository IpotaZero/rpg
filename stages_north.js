...
S.corridor_north_0 = new Stage("北棟0階廊下", 5400, {
  ...
  new Event_Move(new vec(100, 550), 4760, () => S.passage_gym, "ArrowRight", se_door),

  new Event_Move(new vec(810, 550), 1000, () => S.passage_0, "ArrowUp", se_door).set("start", () => { $.getScript("stages_east_and_west.js") }),

  new Event_Move(new vec(2560, 550), 2520, () => S.craft_room, "ArrowUp", se_door),
  new Event_Move(new vec(3920, 550), 740, () => S.craft_room, "ArrowUp", se_door),

  new Event_Move(new vec(5200, 550), 4600, () => S.corridor_north_1, "ArrowUp", se_step),
...
S.corridor_north_1 = new Stage("北棟1階廊下", 5400, {
  ...
  new Event_Move(new vec(810, 550), 1000, () => S.passage_1, "ArrowLeft", se_door).set("start", () => { $.getScript("stages_east_and_west.js") }),

  new Event_Move(new vec(2560, 550), 2520, () => S.laboratory, "ArrowUp", se_door),
  new Event_Move(new vec(3920, 550), 740, () => S.laboratory, "ArrowUp", se_door),

  new Event_Move(new vec(4600, 550), 5200, () => S.corridor_north_0, "ArrowUp", se_step),
  new Event_Move(new vec(5200, 550), 4600, () => S.corridor_north_2, "ArrowUp", se_step),
])
...
S.corridor_north_2 = new Stage("北棟2階廊下", 5400, {
  ...
  new Event_Move(new vec(810, 550), 1000, () => S.passage_2, "ArrowLeft", se_door).set("start", () => { $.getScript("stages_east_and_west.js") }),

  new Event_Move(new vec(2560, 550), 2520, () => S.cooking_room, "ArrowUp", se_door),
  new Event_Move(new vec(3920, 550), 740, () => S.cooking_room, "ArrowUp", se_door),

  new Event_Move(new vec(4600, 550), 5200, () => S.corridor_north_1, "ArrowUp", se_step),
  new Event_Conversation(new vec(5200, 550), 40, null, ["北棟3階へのアクセスには、東棟3階から渡り廊下を通ってください"], se_select),
...
S.corridor_north_3 = new Stage("北棟3階廊下", 4320, {
  ...
  new Event_Move(new vec(810, 550), 1000, () => S.passage_3, "ArrowLeft", se_door).set("start", () => { $.getScript("stages_east_and_west.js") }),

  new Event_Illustlation(new vec(1620, 550), 40, new Iimage("images/il_mirror.png", 0, 0, width, height, { camera: false })),

  new Event_Move(new vec(2290, 550), 1960, () => S.computer_room, "ArrowUp", se_door),
  new Event_Move(new vec(3650, 550), 200, () => S.computer_room, "ArrowUp", se_door),

  new Event_Move(new vec(4220, 550), 200, () => S.balcony, "ArrowUp", se_door),
])
...
S.rooftop_north = new Stage("北棟屋上", 4320, {
  ...
  new Event_Move(new vec(4220, 550), 710, () => S.balcony, "ArrowUp", se_metal),
])
...
S.balcony = new Stage("バルコニー", 810, {
  ...
  new Event_Move(new vec(200, 380), 4220, () => S.corridor_north_3, "ArrowUp", se_door),
  new Event_Move(new vec(710, 380), 4220, () => S.rooftop_north, "ArrowUp", se_metal),
], [], { _height: 550 })
...
S.craft_room = new Stage("技術室", 3240, {
  ...
  new Event_Move(new vec(740, 550), 3920, () => S.corridor_north_0, "ArrowUp", se_door),
  new Event_Move(new vec(2520, 550), 2560, () => S.corridor_north_0, "ArrowUp", se_door),
])
...
S.laboratory = new Stage("理科室", 3240, {
  ...
  new Event_Move(new vec(740, 550), 3920, () => S.corridor_north_1, "ArrowUp", se_door),
  new Event_Move(new vec(2520, 550), 2560, () => S.corridor_north_1, "ArrowUp", se_door),
])
...
S.cooking_room = new Stage("調理室", 3240, {
  ...
  new Event_Move(new vec(740, 550), 3920, () => S.corridor_north_2, "ArrowUp", se_door),
  ...
  new Event_Move(new vec(2520, 550), 2560, () => S.corridor_north_2, "ArrowUp", se_door),
])
...
S.computer_room = new Stage("コンピュータ室", 2160, {
  ...
  new Event_Move(new vec(200, 550), 3650, () => S.corridor_north_3, "ArrowUp", se_door),
  new Event_Move(new vec(1920, 550), 2290, () => S.corridor_north_3, "ArrowUp", se_door),
])
...
S.passage_gym = new Stage("体育館前通路", 4860, {
  ...
  new Event_Move(new vec(100, 550), 2060, () => S.pool_entrance, "ArrowLeft", se_door),

  new Event_Move(new vec(1080, 550), 2700, () => S.gym, "ArrowUp", se_door),
  new Event_Move(new vec(3240, 550), 540, () => S.gym, "ArrowUp", se_door),

  new Event_Move(new vec(4320, 550), 100, () => S.gym_entrance, "ArrowUp", se_road),

  new Event_Move(new vec(4760, 550), 100, () => S.corridor_north_0, "ArrowRight", se_door),
...
S.gym = new Stage("体育館", 3240, {
  ...
  new Event_Move(new vec(100, 550), 540, () => S.gym_entrance, "ArrowLeft", se_door),
  new Event_Move(new vec(540, 550), 3240, () => S.passage_gym, "ArrowUp", se_door),
  new Event_Move(new vec(2700, 550), 1080, () => S.passage_gym, "ArrowUp", se_door),
  new Event_Move(new vec(3140, 550), 100, () => S.gym_stage, "ArrowRight", se_door),
])
...
S.gym_stage = new Stage("壇上", 1080, {
  ...
  new Event_Move(new vec(100, 380), 3140, () => S.gym, "ArrowLeft", se_door),
  new Event_Move(new vec(980, 380), 100, () => S.gym_warehouse, "ArrowRight", se_door),
], [], { _height: 550 })

S.gym_warehouse = new Stage("体育館倉庫", 1080, {
  back: [new Iimage("images/bg_gym_warehouse.png", 0, 0, 1080, 720),]
}, [
  new Event_Move(new vec(100, 550), 980, () => S.gym_stage, "ArrowLeft", se_door),
], [], { lighting: "#00000080" })

S.gym_entrance = new Stage("体育館入口", 1080, {
  back: [new Iimage("images/bg_gym_entrance.png", 0, 0, 1080, 720),]
}, [
  new Event_Move(new vec(100, 550), 4320, () => S.passage_gym, "ArrowLeft", se_road),
  new Event_Move(new vec(540, 550), 100, () => S.gym, "ArrowUp", se_door),
  new Event_Move(new vec(980, 550), 100, () => S.corridor_locker_room, "ArrowRight", se_road),
])
...
S.corridor_locker_room = new Stage("更衣棟", 2160, {
  ...
  new Event_Move(new vec(100, 550), 980, () => S.gym_entrance, "ArrowLeft", se_road),

  new Event_Move(new vec(740, 550), 200, () => S.locker_room_0, "ArrowUp", se_road),
  new Event_Move(new vec(1440, 550), 900, () => S.locker_room_1, "ArrowUp", se_road),


  new Event_Move(new vec(2060, 550), 540, () => S.playground, "ArrowRight", se_road),
])

S.locker_room_0 = new Stage("女子更衣室", 1080, {}, [
  new Event_Move(new vec(200, 550), 740, () => S.corridor_locker_room, "ArrowLeft", se_road),
])

S.locker_room_1 = new Stage("男子更衣室", 1080, {}, [
  new Event_Move(new vec(900, 550), 1440, () => S.corridor_locker_room, "ArrowRight", se_road),
])

S.playground = new Stage("運動場", 6480, {}, [
  new Event_Move(new vec(540, 550), 2060, () => S.corridor_locker_room, "ArrowUp", se_road),
  new Event_Move(new vec(6380, 550), 100, () => S.old_school_back_entrance, "ArrowRight", se_road),
])
...
S.pool_entrance = new Stage("プール更衣室前", 2160, {
  ...
  new Event_Move(new vec(270, 550), 100, () => S.poolside, "ArrowUp", se_step),
  new Event_Move(new vec(760, 550), 980, () => S.pool_locker_room_0, "ArrowUp", se_door),
  new Event_Move(new vec(1460, 550), 100, () => S.pool_locker_room_1, "ArrowUp", se_door),
  new Event_Move(new vec(2060, 550), 100, () => S.passage_gym, "ArrowRight", se_door),
])
...
S.pool_locker_room_0 = new Stage("女子プール更衣室", 1080, {
  ...
  new Event_Move(new vec(980, 550), 760, () => S.pool_entrance, "ArrowRight", se_door)
], { gender: "f" })
...
S.pool_locker_room_1 = new Stage("男子プール更衣室", 1080, {
  ...
  new Event_Move(new vec(100, 550), 1460, () => S.pool_entrance, "ArrowLeft", se_door)
], { gender: "m" })
...
S.poolside = new Stage("プールサイド", 3240, {
  ...
  new Event_Move(new vec(100, 550), 270, () => S.pool_entrance, "ArrowLeft", se_step),
  new Event_Move(new vec(3140, 550), 1350, () => S.entrance_teachers_locker_room, "ArrowRight", se_door),
])
...
S.entrance_teachers_locker_room = new Stage("教員用プール更衣室前", 1620, {
  ...
  new Event_Move(new vec(1350, 550), 3140, () => S.poolside, "ArrowUp", se_door, se_step),
  new Event_Move(new vec(200, 550), 980, () => S.teachers_pool_locker_room_0, "ArrowUp", se_door),
  new Event_Move(new vec(900, 550), 100, () => S.teachers_pool_locker_room_1, "ArrowUp", se_door),
])
...
S.teachers_pool_locker_room_0 = new Stage("女性教員用プール更衣室", 1080, {
  ...
  new Event_Move(new vec(980, 550), 200, () => S.entrance_teachers_locker_room, "ArrowRight", se_door)
], { gender: "f" })

S.teachers_pool_locker_room_1 = new Stage("男性教員用プール更衣室", 1080, {
  back: [new Iimage("images/bg_teachers_locker_room.png", 0, 0, 1080, 720)]
}, [
  new Event_Move(new vec(100, 550), 900, () => S.entrance_teachers_locker_room, "ArrowLeft", se_door),
...
S.old_school_back_entrance = new Stage("旧小学校裏門", 4320, {}, [
  new Event_Move(new vec(100, 550), 6380, () => S.playground, se_road),
  new Event_Move(new vec(2160, 550), 2160, () => S.old_school_back_garden, "ArrowUp", se_road).set("start", () => { $.getScript("stages_old_school.js") }),
], [])